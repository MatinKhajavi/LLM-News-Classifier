...
def parse_args():
    parser = argparse.ArgumentParser(description="Train a GPT-2 model for news classification")
    ...
    parser.add_argument("--output_dir", type=str, default="./gpt2_news_classifier", help="Directory to save the model")
